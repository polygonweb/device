...
;(function() {
    ...
    var internalLinks = [].slice.call(document.querySelectorAll('.list__link_internal'));
    var activeClass = 'list__link_active';
    internalLinks.forEach(function(link, index) {
        link.addEventListener('click', function(e) {
            internalLinks.forEach(function(linkItem, linkIndex) {
                var action = linkIndex === index ? 'add' : 'remove';
                linkItem.classList[action](activeClass);
            });
        })
    });
